...
string LastFmApi::getName(){
    ...
    // some = doc.FirstChildElement("lfm")->FirstChildElement("track")->FirstChildElement("mbind")->GetText();
    // some = doc.FirstChildElement("lfm")->FirstChildElement("track")->FirstChildElement("url")->GetText();
    // some = doc.FirstChildElement("lfm")->FirstChildElement("track")->FirstChildElement("duratin")->GetText();
    // some = doc.FirstChildElement("lfm")->FirstChildElement("track")->FirstChildElement("listeners")->GetText();
    // some = doc.FirstChildElement("lfm")->FirstChildElement("track")->FirstChildElement("playcount")->GetText();
    /*
